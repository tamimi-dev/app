...
async function fetchData(url) {
  ...
  const data = jsonData.feed.entry.map(e => ({
  	id: e.gsx$demap.$t,
    value: Number(e.gsx$deprovtotal.$t),
     value2: Number(e.gsx$dedth.$t),
   //   value3: Number(e.gsx$uscrit.$t),
       value4: Number(e.gsx$deser.$t),
...
fetchData("https://spreadsheets.google.com/feeds/list/12Lyd3k0PRpe-Ie_LaeJaEPm3FwF3iz1gizAOSprn7l0/ox8ow5n/public/values?alt=json");
