...
async function fetchData(url) {
  ...
  const data = jsonData.feed.entry.map(e => ({
  	id: e.gsx$camap.$t,
    value: Number(e.gsx$caprovtotal.$t),
     value2: Number(e.gsx$cadth.$t),
...
fetchData("https://spreadsheets.google.com/feeds/list/12Lyd3k0PRpe-Ie_LaeJaEPm3FwF3iz1gizAOSprn7l0/oto02ve/public/values?alt=json");
