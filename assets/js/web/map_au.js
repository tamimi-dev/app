...
async function fetchData(url) {
  ...
  const data = jsonData.feed.entry.map(e => ({
  	id: e.gsx$aumap.$t,
    value: Number(e.gsx$auprovtotal.$t),
     value2: Number(e.gsx$audth.$t),
      value3: Number(e.gsx$aucrit.$t),
       value4: Number(e.gsx$auser.$t),
        value5: Number(e.gsx$aurecov.$t),
...
fetchData("https://spreadsheets.google.com/feeds/list/12Lyd3k0PRpe-Ie_LaeJaEPm3FwF3iz1gizAOSprn7l0/ov3b4nh/public/values?alt=json");
